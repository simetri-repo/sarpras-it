...
<section class="section">
    <div class="card">
        <form action="{{ url('dataAllUnit2') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="col-md-6 col-12 mb-2">
                    ...
                    <select class="form-control" name="statusselect" id="">
                        ...
                        <option value="{{ $item->id_statUnit }}">{{ $item->nama_statUnit }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-6">
                ...
                <table class='table table-striped display' id="dt_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">{{ $item->tipe_unit }}
                            </td>
                            <td><b>{{ $item->nama_jnsBarang }}</b></td>
                            <td>{{ $item->tgl_regis_unit }}</td>
                            <td>{{ $item->tahun_unit }}</td>
                            <td>{{ $a = date('Y') - $item->tahun_unit }}</td>
                            <td>{{ number_format($item->harga_unit,2,",",".") }}</td>
                            ...
                            <td>{{ $item->ket_unit }}</td>
                            <td><b>{{ $item->nama_peminjam }}</b></td>
                            <td><b>{{ $item->divisi_pinjam }}</b></td>
