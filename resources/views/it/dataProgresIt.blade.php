                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-dark icon" data-bs-toggle="modal"
                                data-bs-target="#accId{{ $item->no_token }}"><i class="far fa-check-circle"></i>
                                SELESAI</button>
                            <!-- Modal -->
                            <div class="modal fade" id="accId{{ $item->no_token }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('ProgresSelesaiIt/'.$item->no_token.'/'.$item->id_unit) }}"
                                            method="post">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="keterangan" class="form-control" id="" rows="3"
                                                            required></textarea>
                                                    </div>
                                                </div>
                                                Progress pengajuan "{{ $item->nama_unit }} {{
