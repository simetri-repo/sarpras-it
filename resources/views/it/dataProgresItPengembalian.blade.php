...
@section('showAllProgres')
active
@endsection

@section('hal')
Data Progress Pengembalian
@endsection
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-dark icon" data-bs-toggle="modal"
                                data-bs-target="#accId{{ $item->id_pengajuan }}"><i class="far fa-check-circle"></i>
                                SELESAI</button>
                            <!-- Modal -->
                            <div class="modal fade" id="accId{{ $item->id_pengajuan }}" tabindex="-1" role="dialog"
                                aria-labelledby="modelTitleId" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title">Confirmation Progres?</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                aria-label="Close"></button>
                                        </div>
                                        <form
                                            action="{{ url('ProgresSelesaiItPengembalian/'.$item->id_pengajuan.'/'.$item->id_unit) }}"
                                            method="post">
                                            @csrf
                                            <div class="modal-body">
                                                ...
                                                $item->nama_user }}, telah dilakukan. Selesaikan Progres?
                                                ?
                                            </div>
