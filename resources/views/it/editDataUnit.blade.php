        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="post" action="{{ url('editUnit/'.$dt_unit->id_unit) }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="first-name-column"
                                            ...
                                            value="{{ $dt_unit->nama_unit }}" placeholder="Nama Unit" name="nama_unit">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="last-name-column"
                                            ...
                                            value="{{ $dt_unit->brand_unit }}" placeholder="Brand Unit"
                                            name="brand_unit">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="city-column"
                                            ...
                                            value="{{ $dt_unit->tipe_unit }}" placeholder="Tipe Unit" name="tipe_unit">
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="country-floating"
                                            ...
                                            name="tahun_unit" value="{{ $dt_unit->tahun_unit }}"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('jenis_unit') is-invalid @enderror"
                                            ...
                                            <option value="{{ $dt_unit->jenis_unit }}">{{ $dt_unit->nama_jnsBarang }}
                                            </option>
                                            <option value="">------------------------------</option>
                                ...
                                @if ($dt_unit->status_unit == 5)
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="email-id-column">Status Unit</label>
                                        <input type="text" id="country-floating"
                                            class="form-control @error('status_unit') is-invalid @enderror"
                                            name="status_unit" value="Dalam Peminjaman" readonly>
                                    </div>
                                </div>
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label for="country-floating">Peminjam</label>
                                        <input type="text" id="country-floating"
                                            class="form-control @error('tahun_unit') is-invalid @enderror"
                                            name="peminjam_id" value="{{ $dt_unit->peminjam }}" readonly>
                                    </div>
                                </div>
                                @else
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select @error('status_unit') is-invalid @enderror"
                                            ...
                                            <option value="{{ $dt_unit->status_unit }}">{{ $dt_unit->nama_statUnit }}
                                            </option>
                                            <option value="">------------------------------</option>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan_unit" class="form-control" id=""
                                            rows="3">{{ $dt_unit->ket_unit }}</textarea>
                                    </div>
                                </div>
