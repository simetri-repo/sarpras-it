                                ...
                                <div class="modal fade" id="accId{{ $item->no_token }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                action="{{ url('hasilPengajuanAtasanManager/1/'.$item->no_token.'/'.$item->id_unit) }}"
                                                method="post">
                                                @csrf
                                ...
                                <div class="modal fade" id="rejectId{{ $item->no_token }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                action="{{ url('hasilPengajuanAtasanManager/9/'.$item->no_token.'/'.$item->id_unit) }}"
                                                method="post">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="col-md-12 col-12">
