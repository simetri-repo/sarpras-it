        ...
        <div class="col-md-8 col-12 mx-auto">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="card-body">
                        <form class="form form-horizontal" method="POST" action="{{ url('pengajuanManager') }}">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <select class="form-select" name="kategoriUnit" id="jnsUnt">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" id="nama_atasan" class="form-control" name="nama_atasan"
                                            value="{{ $atasan[0]->nama_user }}" readonly />
                                        <input type="text" id="atasan" class="form-control" name="atasan"
                                            value="{{ $atasan[0]->nik }}" readonly hidden />
                                    </div>
         ...
         success: function (data) {
            ...
            $("Textarea#ketUnit").val("");
               ...
               $.each(data, function (index, res) {
                 $("#untBrg").append('<option value="' + res.id_unit + '">' + res.nama_unit +' - ' + res.tipe_unit +' - '+ res.brand_unit
                    + '</option>');
