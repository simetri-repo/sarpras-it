                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub @yield('datadivisi')">
                            <a href="#" class='sidebar-link'>
                                <i data-feather="toggle-left" width="20"></i>
                        ...
                        <li class="dropdown">
                            <a href="#" data-bs-toggle="dropdown"
                                ...
                                <div class="avatar me-1">
                                    <img src="{{ asset('assets/images/avatar/avatar-0.png') }}" alt="" srcset="">
                                </div>
                                <div class="d-none d-md-block d-lg-inline-block">Hi, {{ session('username') }}</div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{ url('myaccount') }}"><i data-feather="user"></i>
                                    Account</a>
