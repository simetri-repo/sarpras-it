                                ...
                                <div class="modal fade" id="accId{{ $item->no_token }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                action="{{ url('hasilPengajuanAdminIt/1/'.$item->no_token.'/'.$item->id_unit) }}"
                                                method="post">
                                                @csrf
                                                <div class="modal-body">
                                                    ...
                                                    <div class="col-md-12 col-12">
                                                        ...
                                                        {{-- <div class="form-group">
                                                            <label for="email-id-column">Pilih PIC IT : </label>
                                                            <select name="picUnit" class="form-control" id="">
                                                                @foreach ($dt_pic as $cek)
                                                                <option value="{{ $cek->nik }}">{{ $cek->nama_user }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                        </div> --}}
                                ...
                                <div class="modal fade" id="rejectId{{ $item->no_token }}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                action="{{ url('hasilPengajuanAdminIt/9/'.$item->no_token.'/'.$item->id_unit) }}"
                                                method="post">
                                                @csrf
                                                <div class="modal-body">
                                                    <div class="col-md-12 col-12">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <button type="submit" class="btn btn-danger">Reject</submit>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
